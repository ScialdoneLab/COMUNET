...
#' }
#'
"AML328_d0_interactions"

options(stringsAsFactors = F)

# load CellPhoneDB output for embryo data
data("AML328_d0_CellPhoneDB_output")
...
AML328_d0_interactions <- convert_CellPhoneDB_output(CellPhoneDB_output = AML328_d0_CellPhoneDB_output
                                                  ,complex_input = complex_input
                                                  ,gene_input = gene_input)



use_data(AML328_d0_interactions
         ,overwrite = TRUE)
